...
sqlite3 "$SOCIAL_DB" "INSERT OR IGNORE INTO events (event_id, ts, source, kind, person_id, confidence, payload_json, created_at) VALUES ('$EVENT_ID', '$TS', 'hook', 'human_utterance', 'natsuko', 1.0, '$PAYLOAD', '$CREATED_AT');" 2>/dev/null
